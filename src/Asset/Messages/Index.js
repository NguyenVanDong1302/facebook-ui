export const OtherActionIconMessages = () => (
...
export const UpLoadImageIconMessages = () => (
...
export const UpLoadStickerIconMessages = () => (
...
export const UploadGifIconMessages = () => (
...
export const SendIconIconMessages = () => (
...
export const FBIconMessages = ({ className }) => (
    <i
        className={className}
        style={{
            height: '20px',
            width: '20px',
            backgroundImage: "url('https://static.xx.fbcdn.net/rsrc.php/v3/yH/r/Y9cTej-yQg7.png')",
            backgroundPosition: '-25px -106px',
            backgroundSize: 'auto',
...
export const NotificationIconMessages = ({ className }) => (
    <i
        className={className}
        style={{
            height: '20px',
            width: '20px',
            backgroundImage: "url('https://static.xx.fbcdn.net/rsrc.php/v3/yL/r/g67vQdrxSAs.png')",
...
export const SearchIconMessages = ({ className }) => (
    <i
        className={className}
        style={{
            height: '20px',
            width: '20px',
            backgroundImage: "url('https://static.xx.fbcdn.net/rsrc.php/v3/yF/r/BLXVxF6dcid.png')",
            backgroundPosition: '0px -1209px',
            backgroundSize: 'auto',
            backgroundRepeat: 'no-repeat',
            display: 'inline-block',
        }}
...
export const ArrowDownIconMessages = ({ className }) => (
    <i
        className={className}
        style={{
            height: '20px',
